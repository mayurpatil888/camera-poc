  ...
  startCompression() {
    ...
    RNFFmpeg.execute(executeStr)
      .then(result => {
        ...
        this.uploadToS3({
          uri: `file:///data/user/0/com.testproject/cache/Camera/output_${compreessionStarted}.mp4`,
          type: "video/mp4",
          name: "video.mp4"
        });
      })
        ...
        if (xhr.status === 204) {
          ...
          RNFetchBlob.fs
            ...
            .then(statsInput => {
              RNFetchBlob.fs
                .stat(
                  `file:///data/user/0/com.testproject/cache/Camera/output_${compreessionStarted}.mp4`.substr(
                    7
                  )
                )
                .then(statsOutput => {
